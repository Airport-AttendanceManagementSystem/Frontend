...
function SidebarClock({ collapsed }) {
  ...
  return (
    <Box px={collapsed ? 2 : 3} py={3} flexShrink={0}>
      ...
      {collapsed ? (
        ...
        <Flex align="center" gap={3} px={2}>
          <Flex
            ...
            bg={C.blue700} align="center" justify="center" flexShrink={0}
          >
          ...
          <Box>
            ...
            <Text fontSize="14px" color="rgba(240,239,228,0.83)" letterSpacing="0.05em" mt="2px">
              {formatDate(now)}
            </Text>
          </Box>
        </Flex>
  ...
  return (
    <Tooltip label={collapsed ? item.label : ''} placement="right" hasArrow>
      <Flex
        ...
        bg={isActive ? 'rgba(255,255,255,0.14)' : 'transparent'}
        borderLeft={isActive && !collapsed ? `3px solid ${C.white}` : '3px solid transparent'}
        _hover={{ bg: isActive ? 'rgba(255,255,255,0.14)' : 'rgba(255,255,255,0.07)' }}
        onClick={onClick}
        transition="all 0.15s"
      >
        <Box color={isActive ? C.white : 'rgba(255,255,255,0.5)'} flexShrink={0} transition="color 0.15s">
          <Icon size={17} />
        </Box>
